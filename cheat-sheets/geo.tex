...
\begin{defn}
  ...
  \[ \overline{\kappa}(c) \coloneqq \int_a^b\!\kappa(t) \| c'(t) \| \,\d t \]
...
\begin{satz}
  ...
  \[ U_c \coloneqq \frac{1}{2 \pi} \overline\kappa(c) = \frac{1}{2 \pi} \int_a^b\! \kappa(t) \| c'(t) \| \,\d t \]
...
\begin{defn}
  ...
  \[ \overline\kappa(c) \coloneqq \int_a^b\!\kappa_c(t) \cdot \| c'(t) \|\,\d t. \]
...
\begin{defn}
  ...
  \[ I : U \to \mathrm{SymBild(\R^m)}, \quad u \mapsto I_u \coloneqq \langle \cdot , \cdot \rangle_u. \]
